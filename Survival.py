...
# for random_names,random_data, random_predictions in zip(random_names, random_predictions,random_data):
#     # status = 'Survived' if pred else 'Did not survive'
#     print(f"{random_names}: {random_predictions}")
...
for name, pred in zip(random_data,random_predictions):
    status = 'Survived' if pred else 'Did not survive'
    print(f"{name[random_data]}: {status}")
